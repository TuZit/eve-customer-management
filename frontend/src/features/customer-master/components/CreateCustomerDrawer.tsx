...
import { toCreateCustomerAccountRequestFromForm } from "../adapters/customerFormAdapter";
import {
  AccountKindStep,
...
export function CreateCustomerDrawer() {
  ...
  const accountKind = Form.useWatch("accountKind", form) as
    | AccountKind
    | undefined;
  ...
  const handleSubmit = async () => {
    mutation.mutate(await toCreateCustomerAccountRequestFromForm(form));
  };
